        ...
        <div class="w-box">
          <div class="nav-logo">
            <h1 @click="changePage(-1)">
              <router-link to="/" title="CSU-Shoes">1</router-link>
            </h1>
          </div>
          <div class="right-box">
            <el-autocomplete
              ...
              style="width: 580px; margin-left: 50px; top: 8px"
            >
            </el-autocomplete>
            <div class="nav-list" style="position: relative; left: 230px">
              <router-link to="/goods">
                <a @click="changePage(2)">ALLGoods</a></router-link
              >
              <router-link to="/thanks"
                ><a @click="changePage(4)">AboutUs</a></router-link
              >
      ...
      <slot name="nav">
        <div class="nav-sub" :class="{ fixed: st }">
          ...
          <div
            ...
            :class="{ fixed: st }"
            style="position；relative;left:390px;font-weight:bolder;font-size:20px"
          >
            <div class="w">
              <ul class="nav-list2">
                <li>
